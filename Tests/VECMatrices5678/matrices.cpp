...
/// \brief Multiplication of two 7*7 matrices.
///
/// Original version.
///
/// \param a - first matrix
/// \param b - second matrix
/// \param r - result matrix
void om_mult_mm_7x7_orig(float * __restrict a,
                         float * __restrict b,
                         float * __restrict r)
{
    for (int i = 0; i < V8; i++)
...
/// \param b - second matrix
/// \param r - result matrix
void om_mult_mm_7x7_opt(float * __restrict a,
                        float * __restrict b,
                        float * __restrict r)
{
    ...
    r[ADR(0, 0)] = a[ADR(0,0)]*b[ADR(0,0)]+a[ADR(0,1)]*b[ADR(1,0)]+a[ADR(0,2)]*b[ADR(2,0)]+a[ADR(0,3)]*b[ADR(3,0)]
                 + a[ADR(0,4)]*b[ADR(4,0)]+a[ADR(0,5)]*b[ADR(5,0)]+a[ADR(0,6)]*b[ADR(6,0)];
    r[ADR(0, 1)] = a[ADR(0,0)]*b[ADR(0,1)]+a[ADR(0,1)]*b[ADR(1,1)]+a[ADR(0,2)]*b[ADR(2,1)]+a[ADR(0,3)]*b[ADR(3,1)]
                 + a[ADR(0,4)]*b[ADR(4,1)]+a[ADR(0,5)]*b[ADR(5,1)]+a[ADR(0,6)]*b[ADR(6,1)];
    r[ADR(0, 2)] = a[ADR(0,0)]*b[ADR(0,2)]+a[ADR(0,1)]*b[ADR(1,2)]+a[ADR(0,2)]*b[ADR(2,2)]+a[ADR(0,3)]*b[ADR(3,2)]
                 + a[ADR(0,4)]*b[ADR(4,2)]+a[ADR(0,5)]*b[ADR(5,2)]+a[ADR(0,6)]*b[ADR(6,2)];
    r[ADR(0, 3)] = a[ADR(0,0)]*b[ADR(0,3)]+a[ADR(0,1)]*b[ADR(1,3)]+a[ADR(0,2)]*b[ADR(2,3)]+a[ADR(0,3)]*b[ADR(3,3)]
                 + a[ADR(0,4)]*b[ADR(4,3)]+a[ADR(0,5)]*b[ADR(5,3)]+a[ADR(0,6)]*b[ADR(6,3)];
    r[ADR(0, 4)] = a[ADR(0,0)]*b[ADR(0,4)]+a[ADR(0,1)]*b[ADR(1,4)]+a[ADR(0,2)]*b[ADR(2,4)]+a[ADR(0,3)]*b[ADR(3,4)]
                 + a[ADR(0,4)]*b[ADR(4,4)]+a[ADR(0,5)]*b[ADR(5,4)]+a[ADR(0,6)]*b[ADR(6,4)];
    r[ADR(0, 5)] = a[ADR(0,0)]*b[ADR(0,5)]+a[ADR(0,1)]*b[ADR(1,5)]+a[ADR(0,2)]*b[ADR(2,5)]+a[ADR(0,3)]*b[ADR(3,5)]
                 + a[ADR(0,4)]*b[ADR(4,5)]+a[ADR(0,5)]*b[ADR(5,5)]+a[ADR(0,6)]*b[ADR(6,5)];
    r[ADR(0, 6)] = a[ADR(0,0)]*b[ADR(0,6)]+a[ADR(0,1)]*b[ADR(1,6)]+a[ADR(0,2)]*b[ADR(2,6)]+a[ADR(0,3)]*b[ADR(3,6)]
                 + a[ADR(0,4)]*b[ADR(4,6)]+a[ADR(0,5)]*b[ADR(5,6)]+a[ADR(0,6)]*b[ADR(6,6)];
    r[ADR(0, 7)] = 0.0;

    r[ADR(1, 0)] = a[ADR(1,0)]*b[ADR(0,0)]+a[ADR(1,1)]*b[ADR(1,0)]+a[ADR(1,2)]*b[ADR(2,0)]+a[ADR(1,3)]*b[ADR(3,0)]
                 + a[ADR(1,4)]*b[ADR(4,0)]+a[ADR(1,5)]*b[ADR(5,0)]+a[ADR(1,6)]*b[ADR(6,0)];
    r[ADR(1, 1)] = a[ADR(1,0)]*b[ADR(0,1)]+a[ADR(1,1)]*b[ADR(1,1)]+a[ADR(1,2)]*b[ADR(2,1)]+a[ADR(1,3)]*b[ADR(3,1)]
                 + a[ADR(1,4)]*b[ADR(4,1)]+a[ADR(1,5)]*b[ADR(5,1)]+a[ADR(1,6)]*b[ADR(6,1)];
    r[ADR(1, 2)] = a[ADR(1,0)]*b[ADR(0,2)]+a[ADR(1,1)]*b[ADR(1,2)]+a[ADR(1,2)]*b[ADR(2,2)]+a[ADR(1,3)]*b[ADR(3,2)]
                 + a[ADR(1,4)]*b[ADR(4,2)]+a[ADR(1,5)]*b[ADR(5,2)]+a[ADR(1,6)]*b[ADR(6,2)];
    r[ADR(1, 3)] = a[ADR(1,0)]*b[ADR(0,3)]+a[ADR(1,1)]*b[ADR(1,3)]+a[ADR(1,2)]*b[ADR(2,3)]+a[ADR(1,3)]*b[ADR(3,3)]
                 + a[ADR(1,4)]*b[ADR(4,3)]+a[ADR(1,5)]*b[ADR(5,3)]+a[ADR(1,6)]*b[ADR(6,3)];
    r[ADR(1, 4)] = a[ADR(1,0)]*b[ADR(0,4)]+a[ADR(1,1)]*b[ADR(1,4)]+a[ADR(1,2)]*b[ADR(2,4)]+a[ADR(1,3)]*b[ADR(3,4)]
                 + a[ADR(1,4)]*b[ADR(4,4)]+a[ADR(1,5)]*b[ADR(5,4)]+a[ADR(1,6)]*b[ADR(6,4)];
    r[ADR(1, 5)] = a[ADR(1,0)]*b[ADR(0,5)]+a[ADR(1,1)]*b[ADR(1,5)]+a[ADR(1,2)]*b[ADR(2,5)]+a[ADR(1,3)]*b[ADR(3,5)]
                 + a[ADR(1,4)]*b[ADR(4,5)]+a[ADR(1,5)]*b[ADR(5,5)]+a[ADR(1,6)]*b[ADR(6,5)];
    r[ADR(1, 6)] = a[ADR(1,0)]*b[ADR(0,6)]+a[ADR(1,1)]*b[ADR(1,6)]+a[ADR(1,2)]*b[ADR(2,6)]+a[ADR(1,3)]*b[ADR(3,6)]
                 + a[ADR(1,4)]*b[ADR(4,6)]+a[ADR(1,5)]*b[ADR(5,6)]+a[ADR(1,6)]*b[ADR(6,6)];
    r[ADR(1, 7)] = 0.0;

    r[ADR(2, 0)] = a[ADR(2,0)]*b[ADR(0,0)]+a[ADR(2,1)]*b[ADR(1,0)]+a[ADR(2,2)]*b[ADR(2,0)]+a[ADR(2,3)]*b[ADR(3,0)]
                 + a[ADR(2,4)]*b[ADR(4,0)]+a[ADR(2,5)]*b[ADR(5,0)]+a[ADR(2,6)]*b[ADR(6,0)];
    r[ADR(2, 1)] = a[ADR(2,0)]*b[ADR(0,1)]+a[ADR(2,1)]*b[ADR(1,1)]+a[ADR(2,2)]*b[ADR(2,1)]+a[ADR(2,3)]*b[ADR(3,1)]
                 + a[ADR(2,4)]*b[ADR(4,1)]+a[ADR(2,5)]*b[ADR(5,1)]+a[ADR(2,6)]*b[ADR(6,1)];
    r[ADR(2, 2)] = a[ADR(2,0)]*b[ADR(0,2)]+a[ADR(2,1)]*b[ADR(1,2)]+a[ADR(2,2)]*b[ADR(2,2)]+a[ADR(2,3)]*b[ADR(3,2)]
                 + a[ADR(2,4)]*b[ADR(4,2)]+a[ADR(2,5)]*b[ADR(5,2)]+a[ADR(2,6)]*b[ADR(6,2)];
    r[ADR(2, 3)] = a[ADR(2,0)]*b[ADR(0,3)]+a[ADR(2,1)]*b[ADR(1,3)]+a[ADR(2,2)]*b[ADR(2,3)]+a[ADR(2,3)]*b[ADR(3,3)]
                 + a[ADR(2,4)]*b[ADR(4,3)]+a[ADR(2,5)]*b[ADR(5,3)]+a[ADR(2,6)]*b[ADR(6,3)];
    r[ADR(2, 4)] = a[ADR(2,0)]*b[ADR(0,4)]+a[ADR(2,1)]*b[ADR(1,4)]+a[ADR(2,2)]*b[ADR(2,4)]+a[ADR(2,3)]*b[ADR(3,4)]
                 + a[ADR(2,4)]*b[ADR(4,4)]+a[ADR(2,5)]*b[ADR(5,4)]+a[ADR(2,6)]*b[ADR(6,4)];
    r[ADR(2, 5)] = a[ADR(2,0)]*b[ADR(0,5)]+a[ADR(2,1)]*b[ADR(1,5)]+a[ADR(2,2)]*b[ADR(2,5)]+a[ADR(2,3)]*b[ADR(3,5)]
                 + a[ADR(2,4)]*b[ADR(4,5)]+a[ADR(2,5)]*b[ADR(5,5)]+a[ADR(2,6)]*b[ADR(6,5)];
    r[ADR(2, 6)] = a[ADR(2,0)]*b[ADR(0,6)]+a[ADR(2,1)]*b[ADR(1,6)]+a[ADR(2,2)]*b[ADR(2,6)]+a[ADR(2,3)]*b[ADR(3,6)]
                 + a[ADR(2,4)]*b[ADR(4,6)]+a[ADR(2,5)]*b[ADR(5,6)]+a[ADR(2,6)]*b[ADR(6,6)];
    r[ADR(2, 7)] = 0.0;

    r[ADR(3, 0)] = a[ADR(3,0)]*b[ADR(0,0)]+a[ADR(3,1)]*b[ADR(1,0)]+a[ADR(3,2)]*b[ADR(2,0)]+a[ADR(3,3)]*b[ADR(3,0)]
                 + a[ADR(3,4)]*b[ADR(4,0)]+a[ADR(3,5)]*b[ADR(5,0)]+a[ADR(3,6)]*b[ADR(6,0)];
    r[ADR(3, 1)] = a[ADR(3,0)]*b[ADR(0,1)]+a[ADR(3,1)]*b[ADR(1,1)]+a[ADR(3,2)]*b[ADR(2,1)]+a[ADR(3,3)]*b[ADR(3,1)]
                 + a[ADR(3,4)]*b[ADR(4,1)]+a[ADR(3,5)]*b[ADR(5,1)]+a[ADR(3,6)]*b[ADR(6,1)];
    r[ADR(3, 2)] = a[ADR(3,0)]*b[ADR(0,2)]+a[ADR(3,1)]*b[ADR(1,2)]+a[ADR(3,2)]*b[ADR(2,2)]+a[ADR(3,3)]*b[ADR(3,2)]
                 + a[ADR(3,4)]*b[ADR(4,2)]+a[ADR(3,5)]*b[ADR(5,2)]+a[ADR(3,6)]*b[ADR(6,2)];
    r[ADR(3, 3)] = a[ADR(3,0)]*b[ADR(0,3)]+a[ADR(3,1)]*b[ADR(1,3)]+a[ADR(3,2)]*b[ADR(2,3)]+a[ADR(3,3)]*b[ADR(3,3)]
                 + a[ADR(3,4)]*b[ADR(4,3)]+a[ADR(3,5)]*b[ADR(5,3)]+a[ADR(3,6)]*b[ADR(6,3)];
    r[ADR(3, 4)] = a[ADR(3,0)]*b[ADR(0,4)]+a[ADR(3,1)]*b[ADR(1,4)]+a[ADR(3,2)]*b[ADR(2,4)]+a[ADR(3,3)]*b[ADR(3,4)]
                 + a[ADR(3,4)]*b[ADR(4,4)]+a[ADR(3,5)]*b[ADR(5,4)]+a[ADR(3,6)]*b[ADR(6,4)];
    r[ADR(3, 5)] = a[ADR(3,0)]*b[ADR(0,5)]+a[ADR(3,1)]*b[ADR(1,5)]+a[ADR(3,2)]*b[ADR(2,5)]+a[ADR(3,3)]*b[ADR(3,5)]
                 + a[ADR(3,4)]*b[ADR(4,5)]+a[ADR(3,5)]*b[ADR(5,5)]+a[ADR(3,6)]*b[ADR(6,5)];
    r[ADR(3, 6)] = a[ADR(3,0)]*b[ADR(0,6)]+a[ADR(3,1)]*b[ADR(1,6)]+a[ADR(3,2)]*b[ADR(2,6)]+a[ADR(3,3)]*b[ADR(3,6)]
                 + a[ADR(3,4)]*b[ADR(4,6)]+a[ADR(3,5)]*b[ADR(5,6)]+a[ADR(3,6)]*b[ADR(6,6)];
    r[ADR(3, 7)] = 0.0;

    r[ADR(4, 0)] = a[ADR(4,0)]*b[ADR(0,0)]+a[ADR(4,1)]*b[ADR(1,0)]+a[ADR(4,2)]*b[ADR(2,0)]+a[ADR(4,3)]*b[ADR(3,0)]
                 + a[ADR(4,4)]*b[ADR(4,0)]+a[ADR(4,5)]*b[ADR(5,0)]+a[ADR(4,6)]*b[ADR(6,0)];
    r[ADR(4, 1)] = a[ADR(4,0)]*b[ADR(0,1)]+a[ADR(4,1)]*b[ADR(1,1)]+a[ADR(4,2)]*b[ADR(2,1)]+a[ADR(4,3)]*b[ADR(3,1)]
                 + a[ADR(4,4)]*b[ADR(4,1)]+a[ADR(4,5)]*b[ADR(5,1)]+a[ADR(4,6)]*b[ADR(6,1)];
    r[ADR(4, 2)] = a[ADR(4,0)]*b[ADR(0,2)]+a[ADR(4,1)]*b[ADR(1,2)]+a[ADR(4,2)]*b[ADR(2,2)]+a[ADR(4,3)]*b[ADR(3,2)]
                 + a[ADR(4,4)]*b[ADR(4,2)]+a[ADR(4,5)]*b[ADR(5,2)]+a[ADR(4,6)]*b[ADR(6,2)];
    r[ADR(4, 3)] = a[ADR(4,0)]*b[ADR(0,3)]+a[ADR(4,1)]*b[ADR(1,3)]+a[ADR(4,2)]*b[ADR(2,3)]+a[ADR(4,3)]*b[ADR(3,3)]
                 + a[ADR(4,4)]*b[ADR(4,3)]+a[ADR(4,5)]*b[ADR(5,3)]+a[ADR(4,6)]*b[ADR(6,3)];
    r[ADR(4, 4)] = a[ADR(4,0)]*b[ADR(0,4)]+a[ADR(4,1)]*b[ADR(1,4)]+a[ADR(4,2)]*b[ADR(2,4)]+a[ADR(4,3)]*b[ADR(3,4)]
                 + a[ADR(4,4)]*b[ADR(4,4)]+a[ADR(4,5)]*b[ADR(5,4)]+a[ADR(4,6)]*b[ADR(6,4)];
    r[ADR(4, 5)] = a[ADR(4,0)]*b[ADR(0,5)]+a[ADR(4,1)]*b[ADR(1,5)]+a[ADR(4,2)]*b[ADR(2,5)]+a[ADR(4,3)]*b[ADR(3,5)]
                 + a[ADR(4,4)]*b[ADR(4,5)]+a[ADR(4,5)]*b[ADR(5,5)]+a[ADR(4,6)]*b[ADR(6,5)];
    r[ADR(4, 6)] = a[ADR(4,0)]*b[ADR(0,6)]+a[ADR(4,1)]*b[ADR(1,6)]+a[ADR(4,2)]*b[ADR(2,6)]+a[ADR(4,3)]*b[ADR(3,6)]
                 + a[ADR(4,4)]*b[ADR(4,6)]+a[ADR(4,5)]*b[ADR(5,6)]+a[ADR(4,6)]*b[ADR(6,6)];
    r[ADR(4, 7)] = 0.0;

    r[ADR(5, 0)] = a[ADR(5,0)]*b[ADR(0,0)]+a[ADR(5,1)]*b[ADR(1,0)]+a[ADR(5,2)]*b[ADR(2,0)]+a[ADR(5,3)]*b[ADR(3,0)]
                 + a[ADR(5,4)]*b[ADR(4,0)]+a[ADR(5,5)]*b[ADR(5,0)]+a[ADR(5,6)]*b[ADR(6,0)];
    r[ADR(5, 1)] = a[ADR(5,0)]*b[ADR(0,1)]+a[ADR(5,1)]*b[ADR(1,1)]+a[ADR(5,2)]*b[ADR(2,1)]+a[ADR(5,3)]*b[ADR(3,1)]
                 + a[ADR(5,4)]*b[ADR(4,1)]+a[ADR(5,5)]*b[ADR(5,1)]+a[ADR(5,6)]*b[ADR(6,1)];
    r[ADR(5, 2)] = a[ADR(5,0)]*b[ADR(0,2)]+a[ADR(5,1)]*b[ADR(1,2)]+a[ADR(5,2)]*b[ADR(2,2)]+a[ADR(5,3)]*b[ADR(3,2)]
                 + a[ADR(5,4)]*b[ADR(4,2)]+a[ADR(5,5)]*b[ADR(5,2)]+a[ADR(5,6)]*b[ADR(6,2)];
    r[ADR(5, 3)] = a[ADR(5,0)]*b[ADR(0,3)]+a[ADR(5,1)]*b[ADR(1,3)]+a[ADR(5,2)]*b[ADR(2,3)]+a[ADR(5,3)]*b[ADR(3,3)]
                 + a[ADR(5,4)]*b[ADR(4,3)]+a[ADR(5,5)]*b[ADR(5,3)]+a[ADR(5,6)]*b[ADR(6,3)];
    r[ADR(5, 4)] = a[ADR(5,0)]*b[ADR(0,4)]+a[ADR(5,1)]*b[ADR(1,4)]+a[ADR(5,2)]*b[ADR(2,4)]+a[ADR(5,3)]*b[ADR(3,4)]
                 + a[ADR(5,4)]*b[ADR(4,4)]+a[ADR(5,5)]*b[ADR(5,4)]+a[ADR(5,6)]*b[ADR(6,4)];
    r[ADR(5, 5)] = a[ADR(5,0)]*b[ADR(0,5)]+a[ADR(5,1)]*b[ADR(1,5)]+a[ADR(5,2)]*b[ADR(2,5)]+a[ADR(5,3)]*b[ADR(3,5)]
                 + a[ADR(5,4)]*b[ADR(4,5)]+a[ADR(5,5)]*b[ADR(5,5)]+a[ADR(5,6)]*b[ADR(6,5)];
    r[ADR(5, 6)] = a[ADR(5,0)]*b[ADR(0,6)]+a[ADR(5,1)]*b[ADR(1,6)]+a[ADR(5,2)]*b[ADR(2,6)]+a[ADR(5,3)]*b[ADR(3,6)]
                 + a[ADR(5,4)]*b[ADR(4,6)]+a[ADR(5,5)]*b[ADR(5,6)]+a[ADR(5,6)]*b[ADR(6,6)];
    r[ADR(5, 7)] = 0.0;

    r[ADR(6, 0)] = a[ADR(6,0)]*b[ADR(0,0)]+a[ADR(6,1)]*b[ADR(1,0)]+a[ADR(6,2)]*b[ADR(2,0)]+a[ADR(6,3)]*b[ADR(3,0)]
                 + a[ADR(6,4)]*b[ADR(4,0)]+a[ADR(6,5)]*b[ADR(5,0)]+a[ADR(6,6)]*b[ADR(6,0)];
    r[ADR(6, 1)] = a[ADR(6,0)]*b[ADR(0,1)]+a[ADR(6,1)]*b[ADR(1,1)]+a[ADR(6,2)]*b[ADR(2,1)]+a[ADR(6,3)]*b[ADR(3,1)]
                 + a[ADR(6,4)]*b[ADR(4,1)]+a[ADR(6,5)]*b[ADR(5,1)]+a[ADR(6,6)]*b[ADR(6,1)];
    r[ADR(6, 2)] = a[ADR(6,0)]*b[ADR(0,2)]+a[ADR(6,1)]*b[ADR(1,2)]+a[ADR(6,2)]*b[ADR(2,2)]+a[ADR(6,3)]*b[ADR(3,2)]
                 + a[ADR(6,4)]*b[ADR(4,2)]+a[ADR(6,5)]*b[ADR(5,2)]+a[ADR(6,6)]*b[ADR(6,2)];
    r[ADR(6, 3)] = a[ADR(6,0)]*b[ADR(0,3)]+a[ADR(6,1)]*b[ADR(1,3)]+a[ADR(6,2)]*b[ADR(2,3)]+a[ADR(6,3)]*b[ADR(3,3)]
                 + a[ADR(6,4)]*b[ADR(4,3)]+a[ADR(6,5)]*b[ADR(5,3)]+a[ADR(6,6)]*b[ADR(6,3)];
    r[ADR(6, 4)] = a[ADR(6,0)]*b[ADR(0,4)]+a[ADR(6,1)]*b[ADR(1,4)]+a[ADR(6,2)]*b[ADR(2,4)]+a[ADR(6,3)]*b[ADR(3,4)]
                 + a[ADR(6,4)]*b[ADR(4,4)]+a[ADR(6,5)]*b[ADR(5,4)]+a[ADR(6,6)]*b[ADR(6,4)];
    r[ADR(6, 5)] = a[ADR(6,0)]*b[ADR(0,5)]+a[ADR(6,1)]*b[ADR(1,5)]+a[ADR(6,2)]*b[ADR(2,5)]+a[ADR(6,3)]*b[ADR(3,5)]
                 + a[ADR(6,4)]*b[ADR(4,5)]+a[ADR(6,5)]*b[ADR(5,5)]+a[ADR(6,6)]*b[ADR(6,5)];
    r[ADR(6, 6)] = a[ADR(6,0)]*b[ADR(0,6)]+a[ADR(6,1)]*b[ADR(1,6)]+a[ADR(6,2)]*b[ADR(2,6)]+a[ADR(6,3)]*b[ADR(3,6)]
                 + a[ADR(6,4)]*b[ADR(4,6)]+a[ADR(6,5)]*b[ADR(5,6)]+a[ADR(6,6)]*b[ADR(6,6)];
    r[ADR(6, 7)] = 0.0;
...
/// \brief Multiplication of two 6*6 matrices.
///
/// Original version.
///
/// \param a - first matrix
/// \param b - second matrix
/// \param r - result matrix
void om_mult_mm_6x6_orig(float * __restrict a,
                         float * __restrict b,
                         float * __restrict r)
{
    for (int i = 0; i < V8; i++)
...
/// \param b - second matrix
/// \param r - result matrix
void om_mult_mm_6x6_opt(float * __restrict a,
                        float * __restrict b,
                        float * __restrict r)
{
    ...
    for (int j = 0; j < V8 - 2; j += 2)
    {
        ...
        m2 = SWIZ_2_ADD_2_BLEND_1(m4, m5, _MM_SWIZ_REG_CDAB, 0xAAAA);
        m0 = SWIZ_2_ADD_2_BLEND_1(m0, m1, _MM_SWIZ_REG_BADC, 0xCCCC);
        m1 = SWIZ_2_ADD_2_BLEND_1(m2, z, _MM_SWIZ_REG_BADC, 0xCCCC);
        m2 = PERM_2_ADD_2_BLEND_1(m0, m1, _MM_PERM_CDAB, 0xF0F0);

        _mm512_i32scatter_ps(&r[j], ind_st, m2, _MM_SCALE_4);
    }

    _mm512_i32scatter_ps(&r[V8 - 2], ind_st, z, _MM_SCALE_4);
    ...
    r[ADR(0, 0)] = a[ADR(0,0)]*b[ADR(0,0)]+a[ADR(0,1)]*b[ADR(1,0)]+a[ADR(0,2)]*b[ADR(2,0)]+a[ADR(0,3)]*b[ADR(3,0)]
                 + a[ADR(0,4)]*b[ADR(4,0)]+a[ADR(0,5)]*b[ADR(5,0)];
    r[ADR(0, 1)] = a[ADR(0,0)]*b[ADR(0,1)]+a[ADR(0,1)]*b[ADR(1,1)]+a[ADR(0,2)]*b[ADR(2,1)]+a[ADR(0,3)]*b[ADR(3,1)]
                 + a[ADR(0,4)]*b[ADR(4,1)]+a[ADR(0,5)]*b[ADR(5,1)];
    r[ADR(0, 2)] = a[ADR(0,0)]*b[ADR(0,2)]+a[ADR(0,1)]*b[ADR(1,2)]+a[ADR(0,2)]*b[ADR(2,2)]+a[ADR(0,3)]*b[ADR(3,2)]
                 + a[ADR(0,4)]*b[ADR(4,2)]+a[ADR(0,5)]*b[ADR(5,2)];
    r[ADR(0, 3)] = a[ADR(0,0)]*b[ADR(0,3)]+a[ADR(0,1)]*b[ADR(1,3)]+a[ADR(0,2)]*b[ADR(2,3)]+a[ADR(0,3)]*b[ADR(3,3)]
                 + a[ADR(0,4)]*b[ADR(4,3)]+a[ADR(0,5)]*b[ADR(5,3)];
    r[ADR(0, 4)] = a[ADR(0,0)]*b[ADR(0,4)]+a[ADR(0,1)]*b[ADR(1,4)]+a[ADR(0,2)]*b[ADR(2,4)]+a[ADR(0,3)]*b[ADR(3,4)]
                 + a[ADR(0,4)]*b[ADR(4,4)]+a[ADR(0,5)]*b[ADR(5,4)];
    r[ADR(0, 5)] = a[ADR(0,0)]*b[ADR(0,5)]+a[ADR(0,1)]*b[ADR(1,5)]+a[ADR(0,2)]*b[ADR(2,5)]+a[ADR(0,3)]*b[ADR(3,5)]
                 + a[ADR(0,4)]*b[ADR(4,5)]+a[ADR(0,5)]*b[ADR(5,5)];
    r[ADR(0, 6)] = 0.0;
    r[ADR(0, 7)] = 0.0;

    r[ADR(1, 0)] = a[ADR(1,0)]*b[ADR(0,0)]+a[ADR(1,1)]*b[ADR(1,0)]+a[ADR(1,2)]*b[ADR(2,0)]+a[ADR(1,3)]*b[ADR(3,0)]
                 + a[ADR(1,4)]*b[ADR(4,0)]+a[ADR(1,5)]*b[ADR(5,0)];
    r[ADR(1, 1)] = a[ADR(1,0)]*b[ADR(0,1)]+a[ADR(1,1)]*b[ADR(1,1)]+a[ADR(1,2)]*b[ADR(2,1)]+a[ADR(1,3)]*b[ADR(3,1)]
                 + a[ADR(1,4)]*b[ADR(4,1)]+a[ADR(1,5)]*b[ADR(5,1)];
    r[ADR(1, 2)] = a[ADR(1,0)]*b[ADR(0,2)]+a[ADR(1,1)]*b[ADR(1,2)]+a[ADR(1,2)]*b[ADR(2,2)]+a[ADR(1,3)]*b[ADR(3,2)]
                 + a[ADR(1,4)]*b[ADR(4,2)]+a[ADR(1,5)]*b[ADR(5,2)];
    r[ADR(1, 3)] = a[ADR(1,0)]*b[ADR(0,3)]+a[ADR(1,1)]*b[ADR(1,3)]+a[ADR(1,2)]*b[ADR(2,3)]+a[ADR(1,3)]*b[ADR(3,3)]
                 + a[ADR(1,4)]*b[ADR(4,3)]+a[ADR(1,5)]*b[ADR(5,3)];
    r[ADR(1, 4)] = a[ADR(1,0)]*b[ADR(0,4)]+a[ADR(1,1)]*b[ADR(1,4)]+a[ADR(1,2)]*b[ADR(2,4)]+a[ADR(1,3)]*b[ADR(3,4)]
                 + a[ADR(1,4)]*b[ADR(4,4)]+a[ADR(1,5)]*b[ADR(5,4)];
    r[ADR(1, 5)] = a[ADR(1,0)]*b[ADR(0,5)]+a[ADR(1,1)]*b[ADR(1,5)]+a[ADR(1,2)]*b[ADR(2,5)]+a[ADR(1,3)]*b[ADR(3,5)]
                 + a[ADR(1,4)]*b[ADR(4,5)]+a[ADR(1,5)]*b[ADR(5,5)];
    r[ADR(1, 6)] = 0.0;
    r[ADR(1, 7)] = 0.0;

    r[ADR(2, 0)] = a[ADR(2,0)]*b[ADR(0,0)]+a[ADR(2,1)]*b[ADR(1,0)]+a[ADR(2,2)]*b[ADR(2,0)]+a[ADR(2,3)]*b[ADR(3,0)]
                 + a[ADR(2,4)]*b[ADR(4,0)]+a[ADR(2,5)]*b[ADR(5,0)];
    r[ADR(2, 1)] = a[ADR(2,0)]*b[ADR(0,1)]+a[ADR(2,1)]*b[ADR(1,1)]+a[ADR(2,2)]*b[ADR(2,1)]+a[ADR(2,3)]*b[ADR(3,1)]
                 + a[ADR(2,4)]*b[ADR(4,1)]+a[ADR(2,5)]*b[ADR(5,1)];
    r[ADR(2, 2)] = a[ADR(2,0)]*b[ADR(0,2)]+a[ADR(2,1)]*b[ADR(1,2)]+a[ADR(2,2)]*b[ADR(2,2)]+a[ADR(2,3)]*b[ADR(3,2)]
                 + a[ADR(2,4)]*b[ADR(4,2)]+a[ADR(2,5)]*b[ADR(5,2)];
    r[ADR(2, 3)] = a[ADR(2,0)]*b[ADR(0,3)]+a[ADR(2,1)]*b[ADR(1,3)]+a[ADR(2,2)]*b[ADR(2,3)]+a[ADR(2,3)]*b[ADR(3,3)]
                 + a[ADR(2,4)]*b[ADR(4,3)]+a[ADR(2,5)]*b[ADR(5,3)];
    r[ADR(2, 4)] = a[ADR(2,0)]*b[ADR(0,4)]+a[ADR(2,1)]*b[ADR(1,4)]+a[ADR(2,2)]*b[ADR(2,4)]+a[ADR(2,3)]*b[ADR(3,4)]
                 + a[ADR(2,4)]*b[ADR(4,4)]+a[ADR(2,5)]*b[ADR(5,4)];
    r[ADR(2, 5)] = a[ADR(2,0)]*b[ADR(0,5)]+a[ADR(2,1)]*b[ADR(1,5)]+a[ADR(2,2)]*b[ADR(2,5)]+a[ADR(2,3)]*b[ADR(3,5)]
                 + a[ADR(2,4)]*b[ADR(4,5)]+a[ADR(2,5)]*b[ADR(5,5)];
    r[ADR(2, 6)] = 0.0;
    r[ADR(2, 7)] = 0.0;

    r[ADR(3, 0)] = a[ADR(3,0)]*b[ADR(0,0)]+a[ADR(3,1)]*b[ADR(1,0)]+a[ADR(3,2)]*b[ADR(2,0)]+a[ADR(3,3)]*b[ADR(3,0)]
                 + a[ADR(3,4)]*b[ADR(4,0)]+a[ADR(3,5)]*b[ADR(5,0)];
    r[ADR(3, 1)] = a[ADR(3,0)]*b[ADR(0,1)]+a[ADR(3,1)]*b[ADR(1,1)]+a[ADR(3,2)]*b[ADR(2,1)]+a[ADR(3,3)]*b[ADR(3,1)]
                 + a[ADR(3,4)]*b[ADR(4,1)]+a[ADR(3,5)]*b[ADR(5,1)];
    r[ADR(3, 2)] = a[ADR(3,0)]*b[ADR(0,2)]+a[ADR(3,1)]*b[ADR(1,2)]+a[ADR(3,2)]*b[ADR(2,2)]+a[ADR(3,3)]*b[ADR(3,2)]
                 + a[ADR(3,4)]*b[ADR(4,2)]+a[ADR(3,5)]*b[ADR(5,2)];
    r[ADR(3, 3)] = a[ADR(3,0)]*b[ADR(0,3)]+a[ADR(3,1)]*b[ADR(1,3)]+a[ADR(3,2)]*b[ADR(2,3)]+a[ADR(3,3)]*b[ADR(3,3)]
                 + a[ADR(3,4)]*b[ADR(4,3)]+a[ADR(3,5)]*b[ADR(5,3)];
    r[ADR(3, 4)] = a[ADR(3,0)]*b[ADR(0,4)]+a[ADR(3,1)]*b[ADR(1,4)]+a[ADR(3,2)]*b[ADR(2,4)]+a[ADR(3,3)]*b[ADR(3,4)]
                 + a[ADR(3,4)]*b[ADR(4,4)]+a[ADR(3,5)]*b[ADR(5,4)];
    r[ADR(3, 5)] = a[ADR(3,0)]*b[ADR(0,5)]+a[ADR(3,1)]*b[ADR(1,5)]+a[ADR(3,2)]*b[ADR(2,5)]+a[ADR(3,3)]*b[ADR(3,5)]
                 + a[ADR(3,4)]*b[ADR(4,5)]+a[ADR(3,5)]*b[ADR(5,5)];
    r[ADR(3, 6)] = 0.0;
    r[ADR(3, 7)] = 0.0;

    r[ADR(4, 0)] = a[ADR(4,0)]*b[ADR(0,0)]+a[ADR(4,1)]*b[ADR(1,0)]+a[ADR(4,2)]*b[ADR(2,0)]+a[ADR(4,3)]*b[ADR(3,0)]
                 + a[ADR(4,4)]*b[ADR(4,0)]+a[ADR(4,5)]*b[ADR(5,0)];
    r[ADR(4, 1)] = a[ADR(4,0)]*b[ADR(0,1)]+a[ADR(4,1)]*b[ADR(1,1)]+a[ADR(4,2)]*b[ADR(2,1)]+a[ADR(4,3)]*b[ADR(3,1)]
                 + a[ADR(4,4)]*b[ADR(4,1)]+a[ADR(4,5)]*b[ADR(5,1)];
    r[ADR(4, 2)] = a[ADR(4,0)]*b[ADR(0,2)]+a[ADR(4,1)]*b[ADR(1,2)]+a[ADR(4,2)]*b[ADR(2,2)]+a[ADR(4,3)]*b[ADR(3,2)]
                 + a[ADR(4,4)]*b[ADR(4,2)]+a[ADR(4,5)]*b[ADR(5,2)];
    r[ADR(4, 3)] = a[ADR(4,0)]*b[ADR(0,3)]+a[ADR(4,1)]*b[ADR(1,3)]+a[ADR(4,2)]*b[ADR(2,3)]+a[ADR(4,3)]*b[ADR(3,3)]
                 + a[ADR(4,4)]*b[ADR(4,3)]+a[ADR(4,5)]*b[ADR(5,3)];
    r[ADR(4, 4)] = a[ADR(4,0)]*b[ADR(0,4)]+a[ADR(4,1)]*b[ADR(1,4)]+a[ADR(4,2)]*b[ADR(2,4)]+a[ADR(4,3)]*b[ADR(3,4)]
                 + a[ADR(4,4)]*b[ADR(4,4)]+a[ADR(4,5)]*b[ADR(5,4)];
    r[ADR(4, 5)] = a[ADR(4,0)]*b[ADR(0,5)]+a[ADR(4,1)]*b[ADR(1,5)]+a[ADR(4,2)]*b[ADR(2,5)]+a[ADR(4,3)]*b[ADR(3,5)]
    ...
    r[ADR(5, 1)] = a[ADR(5,0)]*b[ADR(0,1)]+a[ADR(5,1)]*b[ADR(1,1)]+a[ADR(5,2)]*b[ADR(2,1)]+a[ADR(5,3)]*b[ADR(3,1)]
                 + a[ADR(5,4)]*b[ADR(4,1)]+a[ADR(5,5)]*b[ADR(5,1)];
    r[ADR(5, 2)] = a[ADR(5,0)]*b[ADR(0,2)]+a[ADR(5,1)]*b[ADR(1,2)]+a[ADR(5,2)]*b[ADR(2,2)]+a[ADR(5,3)]*b[ADR(3,2)]
                 + a[ADR(5,4)]*b[ADR(4,2)]+a[ADR(5,5)]*b[ADR(5,2)];
    r[ADR(5, 3)] = a[ADR(5,0)]*b[ADR(0,3)]+a[ADR(5,1)]*b[ADR(1,3)]+a[ADR(5,2)]*b[ADR(2,3)]+a[ADR(5,3)]*b[ADR(3,3)]
                 + a[ADR(5,4)]*b[ADR(4,3)]+a[ADR(5,5)]*b[ADR(5,3)];
    r[ADR(5, 4)] = a[ADR(5,0)]*b[ADR(0,4)]+a[ADR(5,1)]*b[ADR(1,4)]+a[ADR(5,2)]*b[ADR(2,4)]+a[ADR(5,3)]*b[ADR(3,4)]
                 + a[ADR(5,4)]*b[ADR(4,4)]+a[ADR(5,5)]*b[ADR(5,4)];
    r[ADR(5, 5)] = a[ADR(5,0)]*b[ADR(0,5)]+a[ADR(5,1)]*b[ADR(1,5)]+a[ADR(5,2)]*b[ADR(2,5)]+a[ADR(5,3)]*b[ADR(3,5)]
                 + a[ADR(5,4)]*b[ADR(4,5)]+a[ADR(5,5)]*b[ADR(5,5)];
    r[ADR(5, 6)] = 0.0;
    r[ADR(5, 7)] = 0.0;
...
/// \brief Multiplication of two 5*5 matrices.
///
/// Original version.
///
/// \param a - first matrix
/// \param b - second matrix
/// \param r - result matrix
void om_mult_mm_5x5_orig(float * __restrict a,
                         float * __restrict b,
                         float * __restrict r)
{
    for (int i = 0; i < V8; i++)
...
/// \param b - second matrix
/// \param r - result matrix
void om_mult_mm_5x5_opt(float * __restrict a,
                        float * __restrict b,
                        float * __restrict r)
{
    ...
    _mm512_i32scatter_ps(&r[6 * V8], ind_st, z, _MM_SCALE_4);
